...
def load_and_chunk(filepath):
    ...
    splited_text = RecursiveCharacterTextSplitter(chunk_size=3000, chunk_overlap=50)#splitting the text into chunks of 500 characters with an overlap of 50 characters.
